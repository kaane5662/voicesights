...
export default function VoiceChatUI() {
  ...
  const [audioLevels, setAudioLevels] = useState([0.3, 0.5, 0.8, 0.6, 0.4, 0.7, 0.5, 0.3]);
          ...
          switch (event.type) {
            ...
            case "conversation.item.input_audio_transcription.completed":
              ...
              if(event.transcript){
                ...
                transcriptContentRef.current.push({start_duration:Math.floor(start/1000),text:event.transcript})
              }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6">
        ...
        {/* Title */}
        <h1 className="text-2xl font-bold mb-2 bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
          {session?.title || "New Voice Session"}
        </h1>
        <p className="text-slate-500 mb-8">{id}</p>

        {/* Timer */}
        <div className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-white/5 border border-white/10 mb-8">
          <div className="w-2 h-2 rounded-full bg-violet-500 animate-pulse" />
          <span className="text-2xl font-mono font-light tracking-wider text-white/90">
      ...
      <div className="relative z-10 p-6 pb-10">
        ...
        <div className="flex items-center justify-center gap-6">
          ...
          <button
            ...
            className={`p-5 rounded-full transition-all duration-300 hover:scale-105 active:scale-95 ${
              isConnected
